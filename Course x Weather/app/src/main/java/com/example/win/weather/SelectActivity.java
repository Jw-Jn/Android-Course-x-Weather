...
public class SelectActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (prefs.getBoolean("city_selected", false)&&!back) {
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    result = HandleResponse.handleProvincesResponse(weatherDB,
                            response);
                } else if ("city".equals(type)) {
                    result = HandleResponse.handleCitiesResponse(weatherDB,
                            response, selectedProvince.getId());
                } else if ("county".equals(type)) {
                    result = HandleResponse.handleCountiesResponse(weatherDB,
